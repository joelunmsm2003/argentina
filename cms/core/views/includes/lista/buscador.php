...
$html_buscador .= $busqueda_activa ?'<button style="float: left;" type="button"><a href="'.base_url().(isset($current_script) ? $current_script : $this->router->fetch_class()).($this->input->get('categ') ? '?categ='.$this->input->get('categ') : '').'">Limpiar</a></button> ' : '';
