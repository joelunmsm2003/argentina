      ...
      <form class="registro" id="form" action="<?php echo base_url().$form_action.$uriParameters ?>" method="post" enctype="multipart/form-data">
        ...
        <legend>Datos</legend>
          ...
          foreach($campos as $key=>$values){
              ...
              .( (isset($values["hidden"]) AND $values["hidden"]) ? 'style="height: 1px; overflow: hidden;"' : '' ).'>';
        ...
        <div class="form__botones">
          ...
          <input id="button2" class="boton" type="button" value="Cancelar" onclick="document.location.href = '<?php echo $return_url ?>'"/>
