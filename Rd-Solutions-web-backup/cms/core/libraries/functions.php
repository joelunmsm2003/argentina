...
class Functions {
	...
	function __construct(){
        ...
        switch($type){
            ...
            case 'form_dropdown_busqueda':
                ...
                if($type == 'form_dropdown_nueva_opcion'){
            		$txt_btn_agregar = (isset($properties['btn_agregar']) AND $properties['btn_agregar']) ? $properties['btn_agregar'] : 'Agregar nuevo';
    ...
    function getChildRelationList($controlador_hermano, $controlador_hijo, $fk_propia, $fk_hermano, $id){
    	...
    	$items = $this->CI->{$hermano->controller_config['model']}->get_query_list();
    	...
    	$total_items = count($items);
   		...
   		'<table class="list list--compact" width="100%" style="margin-bottom:30px;">
    	    <thead>
    	        <tr>
    	            <th colspan="'.($total_items > 20 ? 2 : 1).'" class="js-checkbox-CRL-todos">
